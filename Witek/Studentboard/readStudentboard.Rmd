...
What we got is just a copy of the spreadsheet. Currently it has `r dim(dfData)[1]` rows and `r dim(dfData)[2]` columns. The first two columns contain timestamps the names of all participants and the remaining columns have string values consisting of some quality factor ("Soms" or "Vaak") and a number between brackets.
