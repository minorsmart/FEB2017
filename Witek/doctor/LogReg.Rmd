...
print(cfnMat)
```
Unfortunately the model has hardly any predictive power. We can see from the confusion matrix that when it predicts 0 it is 50% right all the times and when it predicts 1 (= Show-up) it is `r paste0(round(100*cfnMat$table[2,2] / (cfnMat$table[2,1] + cfnMat$table[2,2])), "%")` correct.
